package SeleniumHomeworkClass1;
...
public class HW1 {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        driver.findElement(By.id("customer.firstName")).sendKeys("Ana");
        ...
        driver.findElement(By.id("customer.address.zipCode")).sendKeys("33139");
        ...
        driver.findElement(By.id("customer.username")).sendKeys("user11111");
        driver.findElement(By.id("customer.password")).sendKeys("paSS11111");
        driver.findElement(By.id("repeatedPassword")).sendKeys("paSS11111");
        Thread.sleep(3000);
